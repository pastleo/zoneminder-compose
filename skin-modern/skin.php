...
// Production-ready views (others fallback to classic without changing cookie)
$MODERN_READY_VIEWS = [
  'console',
  'options',
  'watch',
...
$effectiveView = $view ?: (isset($user) ? 'console' : 'login');

if (!in_array($effectiveView, $MODERN_READY_VIEWS)) {
  $skin = 'classic';
  $skinBase = ['classic'];
  $classicSkinFile = 'skins/classic/skin.php';
  if (file_exists($classicSkinFile)) {
    require_once $classicSkinFile;
  }
  return;
}
